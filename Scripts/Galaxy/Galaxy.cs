...
namespace TimelapseInvoices.Scripts.Galaxy;
...
public partial class Galaxy : Node2D
{
    ...
    //行星list
    public List<planet.Planet> Planets { get; set; } = new List<planet.Planet>();
    ...
    //随机数对象
    private Random random = Autoloads.GameManager.GlobalRandom;
    // 星系id
    ...
    public void GeneratePlanets()
    {
        ...
        for (int i = 0; i < planetCount; i++)
        {
            ...
            planet.Planet planet = new planet.Planet
            {
                ...
                Type = (planet.Planet.PlanetType)random.Next(0, 4), // 随机选择行星类型
    ...
    public void CreatePlanets()
    {
        foreach (var planet in Planets)
        {
            ...
            var planetInstance = planetScene.Instantiate<planet.Planet>();
            ...
            foreach (var satellite in planet.Satellites)
            {
                ...
                var satelliteInstance = satelliteScene.Instantiate<planet.Planet>();
