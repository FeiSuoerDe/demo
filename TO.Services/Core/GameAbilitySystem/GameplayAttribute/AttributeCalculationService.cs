...
namespace TO.Services.Core.GameAbilitySystem.GameplayAttribute
{
    ...
    /// </summary>
    public class AttributeCalculationService(
        IEventBusRepo eventbus,
        ILoggerRepo logger) : BaseService, IAttributeCalculationService
    {
        ...
        public IEnumerable<AttributeModifier> OptimizeModifiers(IEnumerable<AttributeModifier> modifiers)
        {
            ...
            logger.Info($"Optimized {modifierList.Count} modifiers to {optimized.Count}");
            return optimized;
        }
