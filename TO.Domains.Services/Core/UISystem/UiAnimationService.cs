using Domains.Core.UISystem.Animations;
using Godot;
...
public class UiAnimationService : BasesService, IUiAnimationService
{
    private readonly IUiAnimationRepo _uiAnimationRepo;

    public UiAnimationService(IUiAnimationRepo uiAnimationRepo)
    {
        _uiAnimationRepo = uiAnimationRepo;
    }
    ...
    private async GDTask<CancellationTokenSource> SetupCancellationToken(Control? control)
    {
        ...
        _uiAnimationRepo.RemoveAnimation(control);
        
        var ctx = new CancellationTokenSource();
        _uiAnimationRepo.AddAnimation(control, ctx);
