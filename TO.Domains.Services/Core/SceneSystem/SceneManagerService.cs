...
{
    public async GDTask ChangeScene(string scenePath, float transitionTime = 1f)
    {
        // 淡出效果
        await sceneManagerRepo.FadeOut(transitionTime);
        ...
        // 淡入效果
        sceneManagerRepo.FadeIn(transitionTime);
    }
