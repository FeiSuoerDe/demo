...
public class NodeSettingsMenuScreenRepo : NodeRepo<ISettingsMenuScreen>, ISettingsMenuScreenRepo
{
    ...
    public NodeSettingsMenuScreenRepo(ISettingsMenuScreen settingsMenuScreen)
    {
